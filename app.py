...
st.set_page_config(
    page_title="Disiplinli Borsa & Kripto Portföy Paneli",
    page_icon="📈",
    layout="wide"
)
...
# --- ANA EKRAN SEKMELERİ ---
tab1, tab2, tab3 = st.tabs(["📈 Hisse Senedi Portföyü", "🪙 Kripto Varlık Portföyü", "🤖 AI Araştırmacı Ajanı"])
...
with tab1:
    ...
    if not df_hisse.empty:
        ...
        # %100 ANLAŞILIR VE DİREKT AÇIK SİLME SİSTEMİ
        st.markdown("---")
